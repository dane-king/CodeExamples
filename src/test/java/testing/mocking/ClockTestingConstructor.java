...
public class ClockTestingConstructor {
    ...
    @Test
    public void originalConstructorStillWorks() {
        assertThat(new ClockClassToTest().getLocalDate(),equalTo(LocalDate.now()));
    }
    @Test
    public void newConstructorWithNullIsSameAsOldConstructor() {
        assertThat(new ClockClassToTest(null).getLocalDate(),equalTo(new ClockClassToTest().getLocalDate()));
    }
